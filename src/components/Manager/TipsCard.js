  ...
  return (
    <div className={classes['card']}>
      <div className={classes.div1} >
        <h2 className={classes.h2}> sdfsdfds\العنوان</h2>
      </div>

      <p className={classes.p}>
        Lorem ipsum dolor sit amet. Ut voluptate assumenda sit maxime fugit ex similique internos et dolorem ipsa sed beatae galisum rem amet quas. Aut odio error aut quia quaerat vel ratione deleniti et cumque quisquam.

        Et dignissimos maiores et consectetur neque vel repellendus blanditiis et sint amet. Rem iusto vitae et soluta molestias et fuga quam vel rerum sunt sed saepe iure? Eum totam dicta vel veniam fuga aut aperiam voluptas ut voluptate possimus et libero deleniti aut eligendi doloremque sed earum perspiciatis. In doloribus rerum et praesentium rerum eos beatae velit et corporis sequi a accusantium temporibus.

        Aut quisquam dolores est maiores facere eum dolor consequatur. Qui mollitia impedit vel molestiae optio sed maxime dolorem qui atque saepe. Et odit facere et enim sunt quo atque totam ut perferendis neque aut consectetur odit.
      </p>
